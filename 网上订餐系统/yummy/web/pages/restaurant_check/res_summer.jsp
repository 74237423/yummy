    ...
    <header id="header">
        <div class="common-width clearfix">
            ...
            <ul class="member logging" ng-init="loginInfo=true">
                ...
                <li class="userName">
                    <a rel="nofollow" draw-user>欢迎，<%=restaurant.getName()%><em></em></a>
                </li>
                <li class="">
                    <a rel="nofollow">
                        <form method='GET' action="/resLogin">
                    ...
                    <article>
                        <section class="add-address-box">
                            <div class="example">
                                ...
                                <table>
                                    <thead>
                                    <tr><th  class="no-sort">订单id</th><th>生成时间</th><th>顾客</th><th>消费金额</th><th  class="no-sort">订单详情</th></tr>
                                    </thead>
                                    <tbody>
                                    <%
                                        ...
                                        for (int i=0;i<orderArrived.size();i++){
                                            ...
                                            out.print("<tr><td>" +orderArrived.get(i).getOrderid()+
                                                    ...
                                                    "</td><td>" +orderArrived.get(i).getTotalprice()+
                                                    "</td><td>" +detail+
                                                    "</td></tr>");
                                        }
                                    %>
                            ...
                            <header><h3>总共：<%=orderArrived.size()%>条记录</h3></header>
                        </section>
                    </article>
                    <article>
                        <section class="add-address-box">
                            <div class="example">
                                ...
                                <table>
                                    <thead>
                                    <tr>
                                        <th  class="no-sort">订单id</th>
                                        <th>生成时间</th>
                                        <th>顾客</th>
                                        <th>消费金额</th>
                                        <th  class="no-sort">订单详情</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <%
                                        ...
                                        for (int i=0;i<orderReturned.size();i++){
                                            ...
                                            out.print("<tr><td>" +orderReturned.get(i).getOrderid()+
                                                    ...
                                                    "</td><td>" +member.getName()+
                                                    "</td><td>" +orderReturned.get(i).getTotalprice()+
                                                    "</td><td>" +detail+
                                                    "</td></tr>");
                                        }
                                    %>
                            ...
                            <header><h3>总共：<%=orderReturned.size()%>条记录</h3></header>
                        </section>
                    </article>
                </section>
            </article>
